...
python ./core/ai/train.py --id E --modules "LazyBatchNorm1d() | LazyLinear(128) | GELU() | LazyLinear(128) | GELU()"
...
@REM Train data owner G's model, 
python ./core/ai/train.py --id G --modules "LazyBatchNorm1d() | LazyLinear(128) | GELU()"

@REM Train data owner T1's model, 
python ./core/ai/train.py --id T1 --modules "LazyBatchNorm1d() | LazyLinear(128) | GELU()"

@REM Train data owner T2's model, 
python ./core/ai/train.py --id T2 --modules "LazyBatchNorm1d() | LazyLinear(128) | GELU()"

@REM Train data owner T3's model, 
python ./core/ai/train.py --id T3 --modules "LazyBatchNorm1d() | LazyLinear(128) | GELU()"