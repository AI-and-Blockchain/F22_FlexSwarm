...
def generate_algorand_keypair(user):
    """Generate a algorand keypair 

    Args:
        user (string): a name for the user

    Returns:
        string: public key, passphrase and private key 
    """
...
def createTxn(algoclient, owner_address, owner_private, client_address, client_private):
    """create the transaction and send to algorand testnet. 

    Args:
        algoclient (_type_): algorand client
        owner_address (string): owner public key
        owner_private (string): owner private key
        client_address (string): client public key
        client_private (string): client private  key
    """
